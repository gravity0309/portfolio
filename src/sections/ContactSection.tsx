          ...
          <Card>
            ...
            >
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <button
                  type="submit"
                  className="inline-flex items-center justify-center rounded-full border border-white bg-white px-6 py-3 text-sm font-medium text-black"
                >
                  Send Message
                </button>
                ...
                {submitted && (
                  <p className="text-sm text-white/60">
                    Thanks for reaching out. Your message is ready to send.
                  </p>
                )}
              </div>
            </form>
